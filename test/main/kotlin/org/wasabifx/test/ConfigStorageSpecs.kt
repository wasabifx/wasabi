...
class ConfigStorageSpecs {
    ...
    @spec fun loading_an_invalid_configuration_with_invalid_property_should_throw_invalid_configuration_exception_with_name_of_invalid_property() {
        ...
        assertTrue(exception.message!!.contains("Invalid property in configuration file: Unrecognized field \"invalid_property\" (class org.wasabifx.app.AppConfiguration), not marked as ignorable"))
    }
