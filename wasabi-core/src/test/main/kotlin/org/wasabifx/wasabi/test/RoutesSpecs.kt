...
import org.wasabifx.wasabi.protocol.http.findRoute
...
class RoutesSpecs {
    ...
    @spec fun finding_a_route_in_the_routing_table_should_return_route() {
        ...
        assertNotNull(findRoute(TestServer.routes, "/1", HttpMethod.GET))
    }
    ...
    @spec fun finding_a_route_in_the_routing_table_by_matching_method_and_path_should_return_route() {
        ...
        assertNotNull(findRoute(TestServer.routes, "/", HttpMethod.GET))
        assertNotNull(findRoute(TestServer.routes, "/third", HttpMethod.POST))
    }
    ...
    @spec fun finding_a_route_in_the_routing_table_with_parameters_and_matching_method_should_return_route() {
        ...
        assertNotNull(findRoute(TestServer.routes, "/first/forest/trees/ENDING", HttpMethod.GET))
    }
    ...
    @spec fun finding_a_similar_route_in_the_routing_table_with_parameters_and_matching_method_should_return_route() {
        ...
        val route1 = findRoute(TestServer.routes, "/page/first", HttpMethod.GET)
        val route2 = findRoute(TestServer.routes, "/page/smt", HttpMethod.GET)
    ...
    @spec fun finding_a_complex_route_in_the_routing_table_with_parameters_and_matching_method_should_return_route() {
        ...
        val route1 = findRoute(TestServer.routes, "/page/one/view", HttpMethod.GET)
        val route2 = findRoute(TestServer.routes, "/page/one/json", HttpMethod.GET)
    ...
    @spec fun finding_a_route_in_the_routing_table_when_path_found_but_not_method_throw_exception_method_not_permitted() {
        ...
        val exception = assertFails({ findRoute(TestServer.routes, "/second", HttpMethod.GET)})
